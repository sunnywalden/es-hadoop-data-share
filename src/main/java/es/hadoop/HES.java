...
public class HES {
  ...
  public static class HesMapper extends Mapper<Object, Text, NullWritable, Text> {
    private static final Logger LOG = LoggerFactory.getLogger(HesMapper.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setMapperClass(HesMapper.class);
