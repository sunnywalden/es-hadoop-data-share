...
public class ESH {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length!=3){
            System.out.println("Usage: MaxTemperature <es.nodes> <es.resource> <output path>");
            System.exit(-1);
        }
...
//        conf.set("es.resource", "logstash-2017.11.27/logs");
        ...
        conf.set("es.query", "?q=userid:0f91c56bcf834e4f9e9ad97ee701813d");
...
//        conf.setBoolean("mapred.output.compress", true);
//        conf.set("mapred.output.compression.type", CompressionType.Text.toString());
//        conf.setClass("mapred.output.compression.codec", "com.hadoop.compression.lzo.LzopCodec.java");
...
//        FileOutputFormat.setOutputPath(job, new Path("hdfs://47.100.76.107:9000/es_output/logstash-new-2017.11.27"));
        ...
        lzoIndexer.run(new String[]{args[2]});
